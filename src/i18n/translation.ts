export const resources = {
  pl: {
    translation: {
      ...
      "new-build-confirm": "Czy na pewno chcesz stworzyć nowy build? Obecny zostanie usunięty!",
      //sets
...
"Redukcja otrzymanych obrażeń biernych":	"Redukcja otrzymanych obrażeń biernych",
"Redukcja otrzymanych obrażeń krytycznych":	"Redukcja otrzymanych obrażeń krytycznych",
...
"Modyfikator trafień magicznych":	"Modyfikator trafień magicznych",
  ...
  en: {
    translation: {
      ...
      "Sieczne": "Slashing",
      //new build confirm dialogue
      "new-build-confirm": "Are you sure you want to create a new build? The current one will be removed!",
      //sets
      "Resztki Reffa": "Resztki Reffa",
      "Okowy Snu": "Okowy Snu",
      "Światła Tellabagu": "Światła Tellabagu",

  ...
  knight: {
    skill1: {
      ...
      description: (
        <div>
          <p>
            Podstawa rycerskiego rzemiosła.Cios ćwiczony przez Rycerzy na każdym
            dworze Taernu.Celny i błyskawiczny atak bronią, zaskakujący
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Obrażenia </td>{" "}
              <td> Szansa trafienia </td> <td> Kondycja </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> 110 % </td> <td> 120 % </td> <td> 12 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 120 % </td> <td> 125 % </td> <td> 14 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 130 % </td> <td> 130 % </td> <td> 16 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 140 % </td> <td> 135 % </td> <td> 18 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 150 % </td> <td> 140 % </td> <td> 19 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 160 % </td> <td> 145 % </td> <td> 21 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 170 % </td> <td> 155 % </td> <td> 23 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),
      ...
      description: (
        <div>
          <p>
            ...
            ich stroną duchową), przez co stali się bardziej podatni na
            uroki.Opracowany przeciwko magom, czarownikom i łucznikom Mierzony
            cios jest techniką mającą odwrócić tę tendencję.Skutecznie
      ...
      table: (
        <table>
          <tbody>
            ...
            <tr>
              <td> I </td> <td> 80 % </td> <td> 100 % </td> <td> 20 </td>{" "}
              <td> -25 % </td> <td> 3 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 85 % </td> <td> 103 % </td> <td> 23 </td>{" "}
              <td> -28 % </td> <td> 3 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 90 % </td> <td> 107 % </td> <td> 26 </td>{" "}
              <td> -31 % </td> <td> 4 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 95 % </td> <td> 110 % </td> <td> 29 </td>{" "}
              <td> -34 % </td> <td> 4 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 100 % </td> <td> 112 % </td> <td> 32 </td>{" "}
              <td> -37 % </td> <td> 5 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 110 % </td> <td> 115 % </td> <td> 35 </td>{" "}
              <td> -41 % </td> <td> 5 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 120 % </td> <td> 118 % </td> <td> 38 </td>{" "}
              <td> -45 % </td> <td> 5 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
    ...
    skill3: {
      ...
      description: (
        <div>
          <p>
            ...
            aby udany atak nawet kilku przeciwników zadał minimalne
            obrażenia.Każdy udany blok jest o 3 % słabszy od poprzedniego i nie
            wpływa na redukcję obrażeń od żywiołów zaklętą w broniach.Użyta
            równocześnie Ochrona osłabia o kolejne 3 % skuteczność bloku.Taka
            zasłona obniża też szansę na trafienie przeciwnika w zwarciu o 22 %
            .{" "}
          </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Ilość bloków </td>{" "}
              <td> Skuteczność bloku </td> <td> Kondycja </td>{" "}
              <td> Trudność </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> 2 </td> <td> 45 % </td> <td> 20 </td>{" "}
              <td> 90 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 3 </td> <td> 50 % </td> <td> 23 </td>{" "}
              <td> 85 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 3 </td> <td> 55 % </td> <td> 26 </td>{" "}
              <td> 80 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 4 </td> <td> 60 % </td> <td> 29 </td>{" "}
              <td> 75 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 4 </td> <td> 65 % </td> <td> 32 </td>{" "}
              <td> 70 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 5 </td> <td> 70 % </td> <td> 35 </td>{" "}
              <td> 65 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 5 </td> <td> 75 % </td> <td> 38 </td>{" "}
              <td> 60 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
    ...
    skill4: {
      ...
      description: (
        <div>
          <p>
            ...
            umożliwiły członkom rycerskiego stanu wchodzenie w
            Trans.Nadnaturalne skupienie i niebywała koncentracja sprawiły, że
            Rycerz w stopniu doskonałym panuje nad swoimi ruchami, dzięki czemu
            jego trafienia są pewniejsze, a rany zadawane wrogom - głębsze.{" "}
          </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Obrażenia fizyczne </td>{" "}
              <td> Atak fizyczny(szansa trafienia) </td> <td> Czas </td>{" "}
              <td> Mana </td> <td> Trudność </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> +15 % </td> <td> +20 % </td> <td> 3 </td>{" "}
              <td> 20 </td> <td> 85 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> +16 % </td> <td> +23 % </td> <td> 3 </td>{" "}
              <td> 23 </td> <td> 80 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> +17 % </td> <td> +26 % </td> <td> 4 </td>{" "}
              <td> 26 </td> <td> 75 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> +18 % </td> <td> +29 % </td> <td> 4 </td>{" "}
              <td> 29 </td> <td> 70 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> +19 % </td> <td> +32 % </td> <td> 5 </td>{" "}
              <td> 32 </td> <td> 65 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> +20 % </td> <td> +35 % </td> <td> 5 </td>{" "}
              <td> 35 </td> <td> 60 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> +22 % </td> <td> +38 % </td> <td> 5 </td>{" "}
              <td> 38 </td> <td> 55 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
    ...
    skill5: {
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Skuteczność Ochrony </td>{" "}
              <td> Kondycja </td> <td> Trudność </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> 70 % </td> <td> 40 </td> <td> 85 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 74 % </td> <td> 46 </td> <td> 80 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 78 % </td> <td> 52 </td> <td> 75 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 82 % </td> <td> 58 </td> <td> 70 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 86 % </td> <td> 64 </td> <td> 65 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 90 % </td> <td> 70 </td> <td> 60 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 95 % </td> <td> 76 </td> <td> 55 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),
      ...
      description: (
        <div>
          <p>
            ...
            najmocniej jak potrafi.Do tego właśnie służy Potężne
            uderzenie.Bardzo energochłonny atak zadaje ogromną ilość ran i
            dziesiątkuję przeciwników.Zawczasu oszołomione postacie otrzymują
            znacznie więcej obrażeń.{" "}
          </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            ...
            <tr>
              <td> I </td> <td> 160 % </td> <td> 100 % </td> <td> 20 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 175 % </td> <td> 103 % </td> <td> 23 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 190 % </td> <td> 107 % </td> <td> 26 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 205 % </td> <td> 110 % </td> <td> 29 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 220 % </td> <td> 112 % </td> <td> 32 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 235 % </td> <td> 114 % </td> <td> 35 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 255 % </td> <td> 117 % </td> <td> 38 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),
    ...
    skill7: {
      ...
      description: (
        <div>
          <p>
            ...
            podatność na czary przeciwników.Aura może służyć tak Rycerzowi jak i
            wybranej przez niego sojuszniczej postaci.{" "}
          </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Obrona przed urokami </td>{" "}
              <td> Odporność na obrażenia od magii </td> <td> Czas </td>{" "}
              <td> Mana </td> <td> Trudność </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> +23 % </td> <td> +15 % </td> <td> 3 </td>{" "}
              <td> 30 </td> <td> 85 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> +27 % </td> <td> +18 % </td> <td> 3 </td>{" "}
              <td> 35 </td> <td> 80 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> +30 % </td> <td> +21 % </td> <td> 4 </td>{" "}
              <td> 39 </td> <td> 75 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> +34 % </td> <td> +24 % </td> <td> 4 </td>{" "}
              <td> 44 </td> <td> 70 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> +37 % </td> <td> +27 % </td> <td> 5 </td>{" "}
              <td> 48 </td> <td> 65 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> +40 % </td> <td> +30 % </td> <td> 5 </td>{" "}
              <td> 53 </td> <td> 60 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> +45 % </td> <td> +34 % </td> <td> 5 </td>{" "}
              <td> 57 </td> <td> 55 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ...
      description: (
        <div>
          <p>
            ...
            urok pozytywny, który obniża jego obronę, wzmacnia za to
            ataki.Odsłaniając się i odnosząc większe obrażenia, dziesiątkuje
            wrogów broniąc zasad, za które gotów jest oddać życie.{" "}
          </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Obrażenia fizyczne </td>{" "}
              <td> Obrona fizyczna </td> <td> Czas </td> <td> Mana </td>{" "}
              <td> Trudność </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> +30 % </td> <td> -15 % </td> <td> 5 </td>{" "}
              <td> 30 </td> <td> 90 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> +32 % </td> <td> -16 % </td> <td> 5 </td>{" "}
              <td> 35 </td> <td> 85 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> +34 % </td> <td> -17 % </td> <td> 6 </td>{" "}
              <td> 39 </td> <td> 80 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> +36 % </td> <td> -18 % </td> <td> 6 </td>{" "}
              <td> 44 </td> <td> 75 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> +38 % </td> <td> -19 % </td> <td> 7 </td>{" "}
              <td> 48 </td> <td> 70 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> +40 % </td> <td> -20 % </td> <td> 7 </td>{" "}
              <td> 52 </td> <td> 65 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> +43 % </td> <td> -20 % </td> <td> 7 </td>{" "}
              <td> 57 </td> <td> 60 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
    ...
    skill9: {
      ...
      description: (
        <div>
          <p>
            ...
            stronie wywołuje poczucie jedności, które zwiększa ich zapał i
            siłę.Postacie pod wpływem siły jedności zadają większe obrażenia
            oraz są skuteczniejsze.{" "}
          </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Zadawane obrażenia </td>{" "}
              <td> Skuteczność ataków </td> <td> Czas </td> <td> Kondycja </td>{" "}
              <td> Mana </td> <td> Trudność </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> +15 % </td> <td> +15 % </td> <td> 3 </td>{" "}
              <td> 15 </td> <td> 40 </td> <td> 85 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> +17 % </td> <td> +17 % </td> <td> 3 </td>{" "}
              <td> 18 </td> <td> 46 </td> <td> 80 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> +19 % </td> <td> +19 % </td> <td> 4 </td>{" "}
              <td> 20 </td> <td> 52 </td> <td> 75 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> +21 % </td> <td> +21 % </td> <td> 4 </td>{" "}
              <td> 22 </td> <td> 58 </td> <td> 70 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> +23 % </td> <td> +23 % </td> <td> 5 </td>{" "}
              <td> 24 </td> <td> 64 </td> <td> 65 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> +25 % </td> <td> +25 % </td> <td> 5 </td>{" "}
              <td> 27 </td> <td> 70 </td> <td> 60 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> +29 % </td> <td> +29 % </td> <td> 5 </td>{" "}
              <td> 28 </td> <td> 76 </td> <td> 55 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),

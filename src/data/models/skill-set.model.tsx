  ...
  constructor(charClass: string) {
    this.skill1 = {
      ...
      description: (
        <div>
          ...
          <p> Dostępne od 1 poziomu doświadczenia </p> <p> Atak fizyczny </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            ...
            <tr>
              <td> I </td> <td> 80 % </td> <td> +20 % </td> <td> 8 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 85 % </td> <td> +25 % </td> <td> 9 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 90 % </td> <td> +30 % </td> <td> 10 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 95 % </td> <td> +35 % </td> <td> 12 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 100 % </td> <td> +40 % </td> <td> 13 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 110 % </td> <td> +45 % </td> <td> 14 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 120 % </td> <td> +50 % </td> <td> 15 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),
    ...
    this.skill2 = {
      ...
      description: (
        <div>
          ...
          <p> Dostępne od 1 poziomu doświadczenia </p> <p> Atak psychiczny </p>{" "}
          <p> Efekt: Strach </p>{" "}
        </div>
      ),
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Czas trwania </td>{" "}
              <td> Szansa trafienia wszelkich ataków </td> <td> Mana </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> 5 </td> <td> -15 % </td> <td> 30 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 5 </td> <td> -20 % </td> <td> 34 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 6 </td> <td> -25 % </td> <td> 39 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 6 </td> <td> -30 % </td> <td> 44 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 6 </td> <td> -35 % </td> <td> 48 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 6 </td> <td> -40 % </td> <td> 53 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 6 </td> <td> -45 % </td> <td> 57 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),
    ...
    this.skill3 = {
      ...
      description: (
        <div>
          <p>
            Podstawowy atak dystansowy.Zadaje niewielką liczbę obrażeń, ale może
            być wykonywany nawet gdy postać wyposażona jest w miecz i tarczę.Nie
            wymaga żadnej broni dystansowej.{" "}
          </p>{" "}
          <p> Dostępne od 1 poziomu doświadczenia </p> <p> Atak dystansowy </p>{" "}
    ...
    this.skill4 = {
      ...
      description: (
        <div>
          <p>
            Podstawowy atak dystansowy przy użyciu broni dalekiego
            zasięgu.Korzystając z tej umiejętności możemy atakować za pomocą
            łuku.{" "}
          </p>{" "}
          <p> Dostępne od 1 poziomu doświadczenia </p> <p> Atak dystansowy </p>{" "}
      ...
      table: (
        <table>
          <tbody>
            ...
            <tr>
              <td> I </td> <td> 100 % </td> <td> +0 % </td> <td> 10 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 110 % </td> <td> +3 % </td> <td> 11 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 120 % </td> <td> +7 % </td> <td> 13 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 130 % </td> <td> +10 % </td> <td> 14 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 140 % </td> <td> +12 % </td> <td> 16 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 150 % </td> <td> +15 % </td> <td> 17 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 160 % </td> <td> +20 % </td> <td> 19 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),
      ...
      table: (
        <table>
          <tbody>
            ...
            <tr>
              <td> II </td> <td> 110 % </td> <td> +3 % </td> <td> 12 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 120 % </td> <td> +7 % </td> <td> 13 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 130 % </td> <td> +10 % </td> <td> 15 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 140 % </td> <td> +12 % </td> <td> 16 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 150 % </td> <td> +15 % </td> <td> 18 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 160 % </td> <td> +20 % </td> <td> 19 </td>{" "}
            </tr>{" "}
    ...
    this.skill7 = {
      ...
      table: (
        <table>
          <tbody>
            <tr>
              <td> Poziom Um </td> <td> Suma Rang </td>{" "}
              <td> Maksymalna ilość petów w drużynie </td>{" "}
            </tr>{" "}
            <tr>
              <td> I </td> <td> 3 </td> <td> 2 </td>{" "}
            </tr>{" "}
            <tr>
              <td> II </td> <td> 4 </td> <td> 2 </td>{" "}
            </tr>{" "}
            <tr>
              <td> III </td> <td> 5 </td> <td> 2 </td>{" "}
            </tr>{" "}
            <tr>
              <td> IV </td> <td> 6 </td> <td> 2 </td>{" "}
            </tr>{" "}
            <tr>
              <td> V </td> <td> 8 </td> <td> 2 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VI </td> <td> 12 </td> <td> 3 </td>{" "}
            </tr>{" "}
            <tr>
              <td> VII </td> <td> 19 </td> <td> 3 </td>{" "}
            </tr>{" "}
          </tbody>{" "}
        </table>
      ),
      ...
      description: (
        <div>
          <p>
            ...
            rund są wrzucone Korzenie x 2.(np.Korzenie na 2 rundy, więc 4
            PA).Działa tylko na rzucającego.{" "}
          </p>{" "}
          <p> Dostępne od 1 poziomu doświadczenia </p>{" "}
